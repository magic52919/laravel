...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button type="submit" id="okOrCancel" name="okOrCancel" value="ok" class="btn btn-success">OK</button>
    <button type="submit" id="okOrCancel" name="okOrCancel" value="cancel" class="btn btn-danger">Cancel</button>
